...
<div class="page_top_wrap page_top_title page_top_breadcrumbs" style="background:url(<?php echo $coverImageUrl; ?>) no-repeat 59% 49%;max-height: 250px;background-size: cover;">
    <div class="content_wrap">
        <div class="breadcrumbs">
            <a class="breadcrumbs_item home" href="index.php">Home</a>
            <span class="breadcrumbs_delimiter"></span>
            <span class="breadcrumbs_item current">Accounting Concept</span>
        </div>
        <h1 class="page_title">Accounting Concept</h1>
    </div>
</div>
          ...
          var cls =  txName.trim();
           var   strd = cls.replace(/ /g,'');
            if (strd.length > 0) {
                let headerHeight = $('.main-menu_wrap_bg').outerHeight() + 20;
                window.scroll({
                    top: $($('.'+strd)).offset().top- headerHeight,
                    left: 0,
                    behavior: 'smooth'
                });
            }
