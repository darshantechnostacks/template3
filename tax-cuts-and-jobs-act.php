...
<!--                <section id="dvOverview" class="grey_section margin_bottom_small padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini">
                    <p class="info-text">Overview</p>
                    <p class="margin_bottom_mini">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                    ...
                    <div class="margin_bottom_mini padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini white_section">
                        <h5>
                            <a href="#!">The Tax Cut and Jobs Act (TCJA) Summaries</a>
                        </h5>
                        <p>
                            <a href="#!">Read More »</a>
                        </p>
                ...
                <section id="dvBusinesses" class="grey_section margin_bottom_small padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini">
                    <p class="info-text">Businesses</p>
                    <p class="margin_bottom_mini">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor
                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                        nostrud
                    ...
                    <div class="margin_bottom_mini padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini white_section">
                        <h5>
                            <a href="#!">A review of significant TCJA provisions affecting businesses</a>
                        </h5>
                        <p>
                            <a href="#!">Read More »</a>
                        </p>
                    ...
                    <div class="margin_bottom_mini padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini white_section">
                        <h5>
                            <a href="#!">The pass-through provisions of the TCJA: The devil is in the
                                details</a>
                        </h5>
                        <p>
                            <a href="#!">Read More »</a>
                    ...
                    <div class="margin_bottom_mini padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini white_section">
                        <h5>
                            <a href="#!">IRS issues updated 2018 withholding tables</a>
                        </h5>
                        <p>
                            <a href="#!">Read More »</a>
                        </p>
                ...
                <section id="dvIndividuals" class="grey_section margin_bottom_small padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini">
                    <p class="info-text">Individuals</p>
                    <p class="margin_bottom_mini">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor
                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                        nostrud
                    ...
                    <div class="margin_bottom_mini padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini white_section">
                        <h5>
                            <a href="#!">Home equity borrowers get good news from the IRS</a>
                        </h5>
                        <p>
                            <a href="#!">Read More »</a>
                        </p>
                ...
                <section id="dvNonprofits" class="grey_section margin_bottom_small padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini">
                    <p class="info-text">Nonprofits</p>
                    <p class="margin_bottom_mini">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor
                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                        nostrud
                    ...
                    <div class="margin_bottom_mini padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini white_section">
                        <h5>
                            <a href="#!">How Does the Tax Cuts and Jobs Act Affect Nonprofits?</a>
                        </h5>
                        <p>
                            <a href="#!">Read More »</a>
                        </p>
                ...
                <section id="dvEstaes" class="grey_section margin_bottom_small padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini">
                    <p class="info-text">Estates</p>
                    <p class="margin_bottom_mini">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor
                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                        nostrud
                ...
                <section id="dvTaxPlanning" class="grey_section margin_bottom_small padding_bottom_mini padding_left_mini padding_right_mini padding_top_mini">
                    <p class="info-text">Tax Planning</p>
                    <p class="margin_bottom_mini">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor
                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                        nostrud
