            ...
            <div class="page_top_wrap page_top_title page_top_breadcrumbs" style="background:url(<?php echo API_URL ?>geturl/uploads/document/<?php echo $images; ?>) no-repeat 59% 49%;max-height: 250px;background-size: cover;">
                <div class="content_wrap">
                    <div class="breadcrumbs">
                        ...
                        <span class="breadcrumbs_item current">Client Organizers</span>
                    </div>
                    <h1 class="page_title">Client Organizers</h1>
                </div>
            </div>
            <div class="container padding_bottom_small padding_top_small">
            <?php echo $description; ?>
                <h2 class="sc_title sc_align_center aligncenter fig_border">Download the latest tax forms below</h2>
