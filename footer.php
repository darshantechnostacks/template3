		<footer class="footer_wrap bg_tint_dark footer_style_dark widget_area">
			<div class="content_wrap">
				<div class="columns_wrap with_padding">
						...
						<div class="widget_inner">
							...
							<div class="sc_socials sc_socials_size_small">
								...
								<div class="sc_socials_item">
									...
									<a href="<?php echo isset($settings->twitter_link)?$settings->twitter_link:"";?>" target="_blank" class="social_icons social_tumblr icons">
								...
								<div class="sc_socials_item">
									<a href="<?php echo isset($settings->facebook_link)?$settings->facebook_link:"";?>" target="_blank" class="social_icons social_facebook icons">
								...
								<div class="sc_socials_item">
									<a href="<?php echo isset($settings->google_link)?$settings->google_link:"";?>" target="_blank" class="social_icons social_gplus icons">
					...
					<?php if(count($testimonals) > 0){ $count = count($testimonals);
						...
						<aside class="column-1_4 widget widget_text">
							...
							<div class="textwidget">
								<!-- <a href="testimonialdeatails.php?id=<?php echo $testimonals[$count -1]->id; ?>" style="color: #787C81"> -->
	                                ...
	                                <?php }else{ ?>
									<div class="testim"><?php  echo  str_replace("{company_name}", $homePages->firm_name, substr($testimonals[$count -1]->description,0,250)) ; ?><br>
										<br>
										<img src="<?php echo API_URL ?>geturl/uploads/photo/<?php echo $testimonals[$count -1]->photo; ?>" width="100" height="50">
										<em style="float: right">- <?php echo $testimonals[$count -1]->name; ?></em>
										<br>
										<br>
									</div>
						...
						<div class="textwidget">
							<ul class="sc_list  sc_list_style_iconed">
								<li class="sc_list_item">
									...
									<?php //echo ($homePages->state->state_name != '') ? $homePages->state->state_name.' ,' : ''; ?> <span><?php //echo ($homePages->city->city != '') ? $homePages->city->city : ''; ?></span> <span><?php echo ($homePages->zip_code != '') ? $homePages->zip_code : ''; ?></span>
									</li>
								...
								<li class="sc_list_item">
									...
									<a class="footer_email" href="mailto:<?php echo isset($homePages->firm_email)?$homePages->firm_email:"";?>"><?php echo isset($homePages->firm_email)?$homePages->firm_email:"";?></a>
								</li>
							</ul>
						</div>
					</aside>
