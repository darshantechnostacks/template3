...
<div class="sub-page-banner">
    ...
    <div class="page-title">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2><?php echo isset($settings->partner_title) && !empty($settings->partner_title)?$settings->partner_title:"OUR PROPRIETOR" ?></h2>
                </div>
            </div>
        </div>
    </div>
...
<div class="about-section mb1">
    <div class="container">
        <center>  <h2><?php echo isset($settings->partner_title) && !empty($settings->partner_title)?$settings->partner_title:"OUR PROPRIETOR" ?></h2></center>
        <div class="row">
            <?php
            if (!empty($our_teams)) {
                if($cnt>1){
