...
<div class="container">
    <div class="row">
        <div class="content_wrap" style="border: none;margin-bottom:50px;">
            <div class="container">
                <center><h2>OUR PROPRIETOR MEMBERS</h2></center>
            </div>
                        ...
                        if (!empty($our_teams)) {
                            ...
                            if($cnt > 1){
                                foreach ($our_teams as $key => $value) {
                                    $image = isset($value->photo) ? PHOTO_URL.$value->photo : '';
                                    $name = isset($value->name) ? $value->name : '';
                                    $designation = isset($value->designation) ? $value->designation : '';
                                    $note = isset($value->personal_notes) ? $value->personal_notes : '';
                                    ?>
                                    <a href="our-proprietor-details.php?id=<?= $value->id ?>">
                                    <div class="column">
                                        <div class="card">
                                            <img src="<?= $image ?>"
                                ...
                                <div class="container mt4 mb4">
                                    <div class="col-sm-4 col-xs-12">
                                        <img src="<?= $image ?>" alt="<?= $name ?>" class="img-circle img-responsive team-mate-image" />
                                    </div>
                                    <div class="col-sm-8 col-xs-12">
                                        ...
                                        <div class="mb1">
                                            ...
                                            <p class="font-16 font-light"><?= !empty($our_teams->name_of_college)?$our_teams->name_of_college:""  ?> - <?= !empty($our_teams->degree)?$our_teams->degree:""  ?></p>
                                        </div>
                                        <div class="mb1">
                                            <h3 class="font-18 font-medium text-uppercase">Professional Membership</h3>
                                            <p class="font-16 font-light"><?= !empty($our_teams->professional_membership_label)?$our_teams->professional_membership_label:""  ?> - <?= !empty($our_teams->professional_membership)?$our_teams->professional_membership:""  ?></p>
                                        </div>
                                        ...
                                        <div class="mb2">
                                            ...
                                            <p class="font-16 font-light"><?= !empty($our_teams->number_of_experience)?$our_teams->number_of_experience:""  ?> Years</p>
                                        </div>
                                        <div class="mb2">
