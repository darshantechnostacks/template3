                ...
                <div class="row">
                    ...
                    if (!empty($blogs)) {
                        ...
                        foreach ($blogs as $key => $blog_value) {
                            ...
                            ?>
                            <li>
                                <a href="newsdetails.php?id=<?php echo $blog_value->id; ?>" title="<?php echo $blog_value->title; ?>"><?php echo substr($blog_value->title,0,20).'...'; ?></a>
                            </li>
                        <?php }
                        ...
                        ?>
                            <li class="clearfix">
                                <div class="img-block">
                                    ...
                                    <a href="newsdetails.php?id=<?php echo $value->id; ?>"><img src="<?php echo API_URL ?>geturl/uploads/feature_photo/<?php echo $value->featured_image; ?>" class="img-responsive" style="max-height: 155px;width: 100%;min-height: 155px;"/></a>
                                    <?php } else { ?>
                                        <a class="hover_icon_link inited" href="newsdetails.php?id=<?php echo $value->id; ?>">
                                            <a href="newsdetails.php?id=<?php echo $value->id; ?>"><img alt="<?php echo $value->title; ?>" src="images/default-blog.jpg" class="img-responsive" style="max-height: 155px;min-height: 155px;width: 100%;"></a>
                                        </a>
                                    <?php } ?>
                                </div>
                                <div class="content-block">
                                    <a href="newsdetails.php?id=<?php echo $value->id; ?>" class="title"><?php echo $value->title; ?></a>
                                    <div class="post_info">
                        <span class="post_info_item post_info_posted">
                            <a  class="post_info_date" title="<?php echo date('M j , Y',$dt);?>"><?php echo date('M j , Y',$dt);?></a>
                        </span>
                                    <?php if(isset($value->uteam->name) && !empty($value->uteam->name)) { ?>
                                    <span class="post_info_item post_info_posted">Auth : <?php echo isset($value->uteam->name) ? $value->uteam->name : '' ?></span>
                                    <?php } ?>
                                </div>
                                    <?php 
                                    ...
                                    <a href="newsdetails.php?id=<?php echo $value->id; ?>" class="read-more">Read more</a>
                                </div>
                            </li>
