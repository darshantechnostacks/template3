            ...
            <div class="col-md-offset-1 col-md-10">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            if (!empty($news)) {
                                ...
                                foreach ($news as $key => $value) {
                                    if (!in_array($value->id, $uBlogsStatusIds)) {
                                        ...
                                        <li class="clearfix">
                                            <div class="img-block">
                                                <a href='newsdetails.php?id=<?= $value->id ?>'>
                                                    <?php
                                            ...
                                            <div class="content-block">
                                                ...
                                                <p><?= strip_tags(substr($blog_content, 0, 100) . '...') ?></p>
                                                    ...
                                                    <?php if(isset($value->blogs_category->category_name)){
                                                        echo "| <b>Category :</b> ".$value->blogs_category->category_name;
                                                    } ?>
                                                    <?php if (isset($value->uteam->name)) { ?>
                                                    | <b>Auth :</b> <?= $value->uteam->name . ' ' . $value->uteam->last_name ?>
                                                    <?php } ?>
                                                <br/>
                                                <a href="newsdetails.php?id=<?= $value->id ?>" class="read-more">Read
                                                    more</a>
                                            </div>
                                        </li>
                                        <?php
                        ...
                        <button type="submit" name="contact_submit" id="loadnews"
...
<script type="text/javascript">
    ...
    jQuery('#loadnews').on('click', function () {
