...
<head>
<meta charset="UTF-8" />
<title>Credit Card Payoff Calculator - How Long To Pay Off Credit Card?</title>
...
function pmtSchedule(form) {
   ...
   if(pmt_count == 0) {
      ...
      while(row_count < pmt_count) {
         ...
         Vpmt_rows += "<tr>n";
         Vpmt_rows += "<td align='right'><font face='arial'><small>" + loanMM + "/" + loanYY + "</small></font></td>n";
         Vpmt_rows += "<td align='right'><font face='arial'><small>" + row_count + "</small></font></td>n";
         Vpmt_rows += "<td align='right'><font face='arial'><small>" + pmt_amt_arr[row_count] + "</small></font></td>n";
         Vpmt_rows += "<td align='right'><font face='arial'><small>" + int_port_arr[row_count] + "</small></font></td>n";
         Vpmt_rows += "<td align='right'><font face='arial'><small>" + prin_port_arr[row_count] + "</small></font></td>n";
         Vpmt_rows += "<td align='right'><font face='arial'><small>" + prin_arr[row_count] + "</small></font></td>n";
         Vpmt_rows += "</tr>n";
...
<tr>
<td colspan="2">
<br><h4 align="center">Credit Card Payoff Calculator</h4>
...
<td align="center">
<input type="text" name="interest" value="18.000" size="15" onkeyup="clear_results(this.form)">
</td>
</tr>
<tr>
<td nowrap="">
...
<tr>
<td nowrap="">
<input type="radio" name="pmtMethod" value="fixed" onclick="clear_results(this.form)"> Fixed Payment You Could Make Each Month:
</td>
<td align="center">
<input type="text" name="fixed_pmt" size="15" value="250.00" onkeyup="clear_results(this.form)">
</td>
</tr>
<tr>
<td colspan="2" align="center">
<input type="button" value="Calculate Credit Card Payoff" onclick="computeForm(this.form)">
...
<tr>
<td align="center" colspan="2">
<input type="button" value="Create Payoff Amortization Schedule" onclick="pmtSchedule(this.form)">
<input type="hidden" name="pmt_rows" value=""><br>
<small><small>Longer term payment schedules make take 30 seconds or more to appear on your screen.</small></small>
</td>
</tr>
</tbody>
</table>
