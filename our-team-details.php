        ...
        <div class="content_wrap">
            <div class="breadcrumbs">
                ...
                <span class="breadcrumbs_delimiter"></span>
                 <a class="breadcrumbs_item home" href="our-teams.php">Our Teams</a>
                <span class="breadcrumbs_delimiter"></span>
                <span class="breadcrumbs_item current">Our Teams Details</span>
            </div>
            <h1 class="page_title">Our Team Details</h1>
        </div>
    </div>
